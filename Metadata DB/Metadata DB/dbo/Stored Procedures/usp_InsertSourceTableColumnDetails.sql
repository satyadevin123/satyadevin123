...
(
@PipelineId INT,@SchemaName VARCHAR(255),@TableName VARCHAR(255),@ColumnName VARCHAR(255),
@KEY INT, @Type VARCHAR(30), @Length VARCHAR(6),@OutputLen VARCHAR(6),
@Decimals VARCHAR(6)
)
AS 
BEGIN
...
(PipelineSourceId,ColumnName,[KEY],[Type],[Length],OutputLen,Decimals)
SELECT
PipelineSourceId,@ColumnName,@KEY,@Type,

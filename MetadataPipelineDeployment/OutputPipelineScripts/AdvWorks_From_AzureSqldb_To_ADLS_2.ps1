...
$pipelinename = "AdvWorks_From_AzureSqldb_To_ADLS_2"
...
$4_2_azureSQLDatabaseDatasetName = "DS_LKP_2"
$4_2_azureSQLDatabaseLinkedServiceName = "LS_MetadataDB"
$5_2_azureSQLDatabaseDatasetName = "DS_CP_SRC_DataCopy_2"
$5_2_azureSQLDatabaseLinkedServiceName = "LS_AdventureWorksAzureSql2"
$6_2_ADLSV2DataSetName = "DS_CP_SINK_DataCopy_2"
$6_2_ADLSV2LinkedServiceName = "LS_ADLSV2"
$6_2_fileSystemFolderName = "frompipeline2"
$6_2_CompressionCodectype = "none"
$6_2_fileformat = "DelimitedText"
$6_2_fileextension = "csv"
$6_2_ColumnDelimiter = ","
#Variables for pipeline Activity Parameters
$Foreach_SourceEntity_2_isSequential = "false"
$LKP_2_LookupActivityname = "LKP_2"
$FE_LKP_LookupActivityname = "FE_LKP"
$FE_LKP_CNT_LookupActivityname = "FE_LKP_CNT"
$LKP_2_query = "SELECT SchemaName,TableName,'DelimitedText' as fileformat,'csv' as fileextension,',' as columnDelimiter,Query, IsIncremental, LastRefreshedBasedOn, 
ISNULL(LastRefreshedDateTime,CAST('1900-01-01 00:00:00.000' AS DATETime)) AS LastRefreshedDateTime,CntQuery  
FROM t_pipeline_tables_tobemoved WHERE IsActive = 1 AND pipelineid = 2"
...
$LKP_2_dataset = "DS_LKP_2"
$FE_LKP_dataset = "DS_CP_SRC_DataCopy_2"
$FE_LKP_CNT_dataset = "DS_CP_SRC_DataCopy_2"
$LKP_2_firstrow = "false"
$FE_LKP_firstrow = "true"
$FE_LKP_CNT_firstrow = "true"
$Foreach_SourceEntity_2_foreachactivityname = "Foreach_SourceEntity_2"
$Foreach_SourceEntity_2_dependson = "LKP_2"
$Foreach_SourceEntity_2_dependencyConditions = "Succeeded"
$Foreach_SourceEntity_2_dependentactivityname = "LKP_2"
$Foreach_SourceEntity_2_batchCount = "20"
$LKP_2_dependson = "SPPipelineInprogressActivity"
$FE_LKP_dependson = ""
$FE_LKP_CNT_dependson = "FE_LKP"
$CP_2_CopyActivityName = "CP_2"
$CP_2_Source = "AzureSqlSource"
$CP_2_Sink = "ParquetSink"
$CP_2_inputDatasetReference = "DS_CP_SRC_DataCopy_2"
$CP_2_outputDatasetReference = "DS_CP_SINK_DataCopy_2"
$CP_2_dependson = ""

$CP_2_parameters = "       ""filename"": {""value"": ""@concat(item().tablename,'_',utcnow())"",""type"": ""Expression""},                                          ""directory"": ""@item().tablename"",                                          ""fileformat"": ""@item().fileformat"",                                          ""fileextension"": ""@item().fileextension"",                                          ""columnDelimiter"": ""@item().columndelimiter"""
$CP_2_sqlReaderQuery = "@if(equals(item().IsIncremental,true),concat(item().Query,' WHERE ',item().LastRefreshedBasedOn ,' > CAST(''',item().LastRefreshedDateTime,''' AS Datetime) AND ',item().LastRefreshedBasedOn,' <= CAST(''',activity('FE_LKP').output.firstrow.maxval,''' AS Datetime)'),item().Query)"
...
$SPPipelineFailedActivity2_dependson = "LKP_2"
$SPPipelineFailedActivity3_dependson = "Foreach_SourceEntity_2"
$SPPipelineSucceededActivity_dependson = "Foreach_SourceEntity_2"
...
$LKP_2_dependencyConditions = "Succeeded"
...
$SP_CopyActivityLogging_dependson = "CP_2"
...
$SPPipelineFailedActivity2_SPParameters = "    { ""In_PipelineName"": {""value"":      {""value"": ""@pipeline().Pipeline"",""type"": ""Expression""},                     ""type"": ""String""                          },    ""In_PipelineStatus"": {                              ""value"": ""Failed"",          ""type"": ""String""                          },                   ""In_ExecutionStartTime"": {                                 ""value"": {                                 ""value"": ""@utcnow()"",          ""type"": ""Expression""                              },                       ""type"": ""Datetime""                          },                           ""In_ExecutionEndTime"": {                              ""value"": ""@utcnow()"",                         ""type"": ""Datetime""                          }            ,              ""In_PipelineRunID"": {""value"":      {""value"": ""@pipeline().RunId"",""type"": ""Expression""},                     ""type"": ""String""                          }  ,                           ""In_ErrorMessage"": {                             
                                   ""value"": ""@activity('LKP_2').Error.Message"",            
                                   ""type"": ""string""                          }   "
$SPPipelineFailedActivity3_SPParameters = "    { ""In_PipelineName"": {""value"":      {""value"": ""@pipeline().Pipeline"",""type"": ""Expression""},                     ""type"": ""String""                          },    ""In_PipelineStatus"": {                              ""value"": ""Failed"",          ""type"": ""String""                          },                   ""In_ExecutionStartTime"": {                                 ""value"": {                                 ""value"": ""@utcnow()"",          ""type"": ""Expression""                              },                       ""type"": ""Datetime""                          },                           ""In_ExecutionEndTime"": {                              ""value"": ""@utcnow()"",                         ""type"": ""Datetime""                          }            ,              ""In_PipelineRunID"": {""value"":      {""value"": ""@pipeline().RunId"",""type"": ""Expression""},                     ""type"": ""String""                          }  ,                           ""In_ErrorMessage"": {                             
                                   ""value"": ""@activity('Foreach_SourceEntity_2').Error.Message"",            
                                   ""type"": ""string""                          }   "
...
$DS_azureADLSv2DataSet_2_5Definition = @"
{    "name": "$6_2_azureADLSV2DataSetName",    "properties": {      "linkedServiceName": {        "referenceName": "$6_2_ADLSV2LinkedServiceName",        "type": "LinkedServiceReference"      },      "parameters": {        "filename": { "type": "string" },        "directory": { "type": "string" },        "fileformat": { "type": "string" },        "fileextension": { "type": "string" },        "columnDelimiter": { "type": "string" }      },      "annotations": [],      "type": "$6_2_fileformat",      "typeProperties": {        "location": {          "type": "AzureBlobFSLocation",          "fileName": {            "value": "@concat(dataset().filename,'.',dataset().fileextension)",            "type": "Expression"          },          "folderPath": {            "value": "@dataset().directory",            "type": "Expression"          },          "fileSystem": "$6_2_fileSystemFolderName"        },        "columnDelimiter": "@dataset().columndelimiter",        "compressionCodec": "$6_2_CompressionCodectype" ,"firstRowAsHeader": true     },      "schema": []    }  }
"@
$DS_azureADLSv2DataSet_2_5Definition | Out-File "$ScriptPath\OutputPipelineScripts\DS_azureADLSv2DataSet_2_5.json"
New-AzDataFactoryV2DataSet -DataFactoryName $dataFactoryName -ResourceGroupName $resourceGroupName -Force -Name "DS_CP_SINK_DataCopy_2" -File "$ScriptPath\OutputPipelineScripts\DS_azureADLSv2DataSet_2_5.json"
$DS_azureSQLDatabaseDataset_2_8Definition = @"
{  "name": "$5_2_azureSQLDatabaseDatasetName",  "properties": {    "type": "AzureSqlTable",    "linkedServiceName": {      "referenceName": "$5_2_azureSQLDatabaseLinkedServiceName", "type": "LinkedServiceReference"},  "typeProperties": { "tableName": "dummy" }}}
"@
$DS_azureSQLDatabaseDataset_2_8Definition | Out-File "$ScriptPath\OutputPipelineScripts\DS_azureSQLDatabaseDataset_2_8.json"
New-AzDataFactoryV2DataSet -DataFactoryName $dataFactoryName -ResourceGroupName $resourceGroupName -Force -Name "DS_CP_SRC_DataCopy_2" -File "$ScriptPath\OutputPipelineScripts\DS_azureSQLDatabaseDataset_2_8.json"
$DS_azureSQLDatabaseDataset_2_8Definition = @"
{  "name": "$4_2_azureSQLDatabaseDatasetName",  "properties": {    "type": "AzureSqlTable",    "linkedServiceName": {      "referenceName": "$4_2_azureSQLDatabaseLinkedServiceName", "type": "LinkedServiceReference"},  "typeProperties": { "tableName": "dummy" }}}
"@
$DS_azureSQLDatabaseDataset_2_8Definition | Out-File "$ScriptPath\OutputPipelineScripts\DS_azureSQLDatabaseDataset_2_8.json"
New-AzDataFactoryV2DataSet -DataFactoryName $dataFactoryName -ResourceGroupName $resourceGroupName -Force -Name "DS_LKP_2" -File "$ScriptPath\OutputPipelineScripts\DS_azureSQLDatabaseDataset_2_8.json"
...
,{"name":"$LKP_2_LookupActivityname","type":"Lookup","dependsOn":[{"activity":"$LKP_2_dependson","dependencyConditions":["$LKP_2_dependencyConditions"]}],"policy":{"timeout":"7.00:00:00","retry":0,"retryIntervalInSeconds":30,"secureOutput":false,"secureInput":false},"userProperties":[],"typeProperties":{"source":{"type":"AzureSqlSource","sqlReaderQuery":{"value":"$LKP_2_query","type":"Expression"},"queryTimeout":"02:00:00"},"dataset":{"referenceName":"$LKP_2_dataset","type":"DatasetReference"},"firstRowOnly":$LKP_2_firstrow}}
...
, {
                "name": "Execute Send Mail for failed activity 43",
...
, {
                "name": "Execute Send Mail for failed activity 45",
                "type": "ExecutePipeline",
                "dependsOn": [
                    {
                ...
                "typeProperties": {
					...
					"EmailTo": "$EmailTo",
                        "Activity": "lkp2",
                        "Message": "failed at activity lkp2",
						"PipelineName": "AdvWorks_From_AzureSqldb_To_ADLS_2"
				}
                }
            }
...
, {
                "name": "Execute Send Mail for failed activity 56",
                "type": "ExecutePipeline",
                "dependsOn": [
                    {
                ...
                "typeProperties": {
                    ...
                    "parameters": {
					"EmailTo": "$EmailTo",
                        "Activity": "foreachsourceentity2",
                        "Message": "failed at activity foreachsourceentity2",
						"PipelineName": "AdvWorks_From_AzureSqldb_To_ADLS_2"
				}
                }
            }
...
"@
$pipelineDefinition | Out-File "$ScriptPath\OutputPipelineScripts\AdvWorks_From_AzureSqldb_To_ADLS_2.json"
